...
$sql = "insert into tb_usuarios(nome_cad, cpf_cad, nasc_cad, email_cad, senha_cad, tel_cad, estado_cad, bairro_cad, rua_cad, num_cad, comp_cad)
values('$nome_cad', $cpf_cad, '$email_cad', '$senha_cad', '$tel_cad', '$estado_cad', '$bairro_cad', '$rua_cad', '$num_cad', '$comp_cad') ";
$count = $con->exec($sql);
?>